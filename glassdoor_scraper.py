# -*- coding: utf-8 -*-
"""
Created on Sat Dec  4 01:40:28 2021
        ...
        if not (len(jobs) >= num_jobs):
            ...
            for job_button in job_buttons:  
                ...
                while not collected_successfully:
                    try:
                       #<div class="css-xuk5ye e1tk4kwz5">Coursera<span data-test="detailRating" class="css-1m5m32b e1tk4kwz4">3.9<span class="css-y6inve e1tk4kwz3"></span></span></div>
                        #company_name = driver.find_element_by_xpath('.//div[@class="employerName"]').text
                        #company_name = driver.find_element_by_xpath('.//div[@class="css-1j389vi e1tk4kwz2"]').text
